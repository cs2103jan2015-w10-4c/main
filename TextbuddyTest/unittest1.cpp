...
{		
	...
	public:	
		...
		TEST_METHOD(clearAllTest) {
			const string ExpOutput = "All message is deleted from heytemp123.txt";
		...
		TEST_METHOD(sortAlphaTest) {
			...
			const string ExpOutput = "All messages in heytemp123.txt are sorted alphabetically";
		...
		TEST_METHOD(searchForWordTest) {
			//const string ExpOutput1 = "Message is found 2 in heytemp123.txt";
			//const string ExpOutput2 = "Message is found 1 in heytemp123.txt";
			const string ExpOutput3 = "message cannot be found in heytemp123.txt";

			//set up file
			TextBuddy::addLine("heytemp123.txt", "sample text");
			TextBuddy::addLine("heytemp123.txt", "I am right");
			TextBuddy::writeToFile("heytemp123.txt");
